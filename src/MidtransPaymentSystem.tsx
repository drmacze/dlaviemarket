...
export default function MidtransPaymentSystem() {
  ...
  const copy = useMemo(() => lang === 'en' ? {
    ...
    eyebrow: 'MIDTRANS · LIVE',
    body: 'Secure payment through Midtrans. Your wallet is credited only after the payment is verified by the server.',
    ...
    none: 'No Midtrans deposits yet.',
    live: 'This integration uses Midtrans Production. Completing checkout can charge real money.',
    invalid: 'Minimum deposit is Rp1,000.',
    failed: 'Could not create the Midtrans payment. Try again in a moment.',
    syncing: 'Checking…',
    ...
    eyebrow: 'MIDTRANS · LIVE',
    body: 'Pembayaran aman melalui Midtrans. Saldo hanya ditambahkan setelah pembayaran diverifikasi oleh server.',
    ...
    none: 'Belum ada deposit Midtrans.',
    live: 'Integrasi ini menggunakan Midtrans Production. Menyelesaikan pembayaran dapat menggunakan uang sungguhan.',
    invalid: 'Minimum deposit adalah Rp1.000.',
    failed: 'Pembayaran Midtrans belum bisa dibuat. Coba lagi sebentar.',
    syncing: 'Memeriksa…',
